  ...
  return (
    <>
      <div className="2xl:background-p2 xl:background-p2 bg-mobile bg-contain w-full xl:h-[42.5rem]">
        ...
        <div className="grid xl:grid-cols-3 grid-cols-1 xl:gap-0 xl:mx-auto xl:container relative top-5 mb-8 p-5">
          <div className="mx-auto my-auto mt-3 xl:mt-0">
            <div
              trigger="hover"
              className="xl:mt-10 bg-gray-100 xl:w-[19.375rem] xl:h-[31.125rem] w-[14rem] h-[19rem] rounded-3xl p-3 stroke-slate-300 xl:hover:shadow-2xl xl:duration-1000 xl:hover:scale-110 xl:hover:shadow-[#3363F3]"
            >
              <img
