  ...
  return (
    <>
      <div className="2xl:background-p2 xl:background-p2 bg-mobile bg-contain w-full xl:h-[53.5rem] ipad:h-[59.5rem]">
        ...
        <div className="grid xl:grid-cols-3 ipad:grid-cols-3 grid-cols-1 xl:gap-0 xl:mx-auto xl:container xl:relative xl:top-24 ipad:relative ipad:top-28 relative top-12 mb-8 p-8">
          <div className="mx-auto my-auto mt-3 xl:mt-0">
            <div
              trigger="hover"
              className="xl:mt-10 bg-gray-100 xl:w-[19.375rem] xl:h-[31.125rem] ipad:w-[15.375rem] ipad:h-[27.125rem] w-[12rem] h-[17rem] rounded-3xl p-3 stroke-slate-300 xl:hover:shadow-2xl xl:duration-1000 xl:hover:scale-110 xl:hover:shadow-[#3363F3]"
            >
              <img
                ...
                alt="imgWeb"
                className="my-10 mt-[10px] xl:mt-[40px] ipad:mt-10"
              ></img>
              <div className="flex">
                <p className="text-[#14357E] mx-auto text-center xl:text-[1.5rem] ipad:text-[1.5rem] text-[1.25rem] font-bold xl:my-8 ipad:mt-10 -mt-3">
                  Website Design
                </p>
              </div>
            </div>
          ...
          <div className="mx-auto my-auto mt-3 xl:mt-0">
            ...
            >
              ...
              ></img>
              <div className="flex">
                <p className="text-[#14357E] mx-auto text-center xl:text-[1.5rem] ipad:text-[1.5rem]  text-[1.25rem] ipad:mt-10 font-bold xl:my-8 -mt-3">
                  Mobile Application
                </p>
              </div>
            </div>
