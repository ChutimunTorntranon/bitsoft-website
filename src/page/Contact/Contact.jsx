...
function Contact() {
  return (
    <div className="background-p4 w-full h-full p-16">
      <div className="container mx-auto h-[5rem]"></div>
      <div className="grid grid-cols-2 container mx-auto">
        <div className="text-[#FFFFFF] my-auto">
          <p className="text-center text-[2.625rem]">ติดต่อเรา</p>
          ...
          <p className="text-center text-[1.5rem]">sale.bitsoft</p>
          <p className="text-center text-[1.5rem]">sale.bitsoft@gmail.com</p>
        </div>
