      ...
      <div className="w-full ipad:h-[5rem]">
        <div className="xl:w-[13.438rem] xl:h-[7.438rem] mx-auto xl:-mt-[5rem] xl:relative xl:left-[18rem] xl:-top-[3rem]">
          <div className="relative mt-1 xl:top-[10rem]">
            <img
              src="https://bitsoft-image-video.s3.ap-southeast-1.amazonaws.com/img-bitsoft/%E0%B9%84%E0%B8%9F%E0%B8%A5%E0%B9%8C%E0%B8%A0%E0%B8%B2%E0%B8%9E%E0%B8%AA%E0%B8%B3%E0%B8%AB%E0%B8%A3%E0%B8%B1%E0%B8%9A+bitsoft/team/Bhon.jpg"
              className="xl:w-[8.5rem] xl:h-[8.5rem] w-[6rem] h-[6rem] mx-auto rounded-3xl border-[0.25rem] border-white"
              alt="ImgCeo"
            />
          </div>
        ...
        <div className="xl:w-[13.438rem] xl:h-[7.438rem] mx-auto ipad:relative ipad:-top-[12.75rem] ipad:left-[12rem]  xl:relative xl:left-[18rem] xl:-top-[3rem]">
          <div className="xl:mt-[-21rem] relative mt-4">
            <img
              ...
              className="xl:z-50 xl:relative xl:top-[23.5rem] xl:left-[20rem] xl:w-[8.5rem] xl:h-[8.5rem] w-[6rem] h-[6rem] mx-auto rounded-3xl border-[0.25rem] border-white"
              alt="ImgCeo"
            />
          </div>
        ...
        <div className="xl:w-[13.438rem] xl:h-[7.438rem] mx-auto ipad:relative ipad:-top-[25.5rem] ipad:left-[24rem]  xl:relative xl:left-[18rem] xl:-top-[3rem]">
          <div className=" xl:mt-[-21rem] relative mt-4">
            <img
              ...
              className="xl:z-50 xl:relative xl:w-[8.5rem] xl:h-[8.5rem] xl:top-[37.15rem] xl:left-[40rem] w-[6rem] h-[6rem] mx-auto rounded-3xl border-[0.25rem] border-white"
              alt="ImgCeo"
            />
          </div>
        ...
        <div className="xl:w-[13.438rem] xl:h-[7.438rem] mx-auto ipad:relative ipad:-top-[38.25rem] ipad:left-[36rem]  xl:relative xl:left-[18rem] xl:-top-[3rem]">
          <div className="xl:mt-[-21rem] relative mt-4">
            <img
              ...
              className="xl:z-50 xl:relative  xl:top-[50.6rem] xl:left-[60rem] xl:w-[8.5rem] xl:h-[8.5rem] w-[6rem] h-[6rem] mx-auto rounded-3xl border-[0.25rem] border-white"
              alt="ImgCeo"
            />
          </div>
